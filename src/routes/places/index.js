...
router.get('/' ,async (req, res) => {
    ...
    try{
        if(req.query.city != undefined){
            ...
            const queryString = `?categoryId=${category_ID}&limit=20&radius=5000&near=${city}&client_id=${config.foursquareClientID}&client_secret=${config.foursquareClientSecret}&v=${config.foursquareVersionDate}`;
